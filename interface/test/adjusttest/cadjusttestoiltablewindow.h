#ifndef CADJUSTTESTOILTABLEWINDOW_H
#define CADJUSTTESTOILTABLEWINDOW_H
...
class CAdjustTestOilTableWindow : public QWidget
{
    Q_OBJECT
public:
    Q_INVOKABLE CAdjustTestOilTableWindow(QWidget *parent = 0);
