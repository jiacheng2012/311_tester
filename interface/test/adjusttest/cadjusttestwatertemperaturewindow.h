#ifndef CADJUSTTESTWATERTEMPWINDOW_H
#define CADJUSTTESTWATERTEMPWINDOW_H
...
class CAdjustTestWaterTemperatureWindow : public QWidget
{
    Q_OBJECT
public:
    Q_INVOKABLE CAdjustTestWaterTemperatureWindow(QWidget *parent = 0);
...
public:
    ...
    void updateInterface(int number,vu16 value,v16 sample);
