#ifndef CADJUSTTESTSPEEDTABLEWINDOW_H
#define CADJUSTTESTSPEEDTABLEWINDOW_H
...
class CAdjustTestSpeedTableWindow : public QWidget
{
    Q_OBJECT
public:
    Q_INVOKABLE CAdjustTestSpeedTableWindow(QWidget *parent = 0);
